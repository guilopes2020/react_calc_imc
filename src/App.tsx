  		...
  		<div className={styles.main}>
			...
			<div className={styles.container}>
				<div className={styles.leftSide}>
					...
					<input type="number" placeholder='Digite seu peso Ex: 75.3 (em Kg)' value={weightField > 0 ? weightField : ''} onChange={e => setWeightField(parseFloat(e.target.value))} disabled={toShow ? true : false} />
				...
				<div className={styles.rightSide}>
					...
					{toShow &&
						<div className={styles.rightBig}>
							<div title='Limpar' className={styles.rightArrow} onClick={handleBackButton}>
